	...
	<h1 id="heading"><strong >Welcome to Cricket Fantasy League</strong></h1><br><br><br><br>
		<div id="list_of_item">
			<ul id="list">
				...
				<li><a href="players.php" target="_blank" id="player_selection" class="list_col">Player Selection</a></li>
				<li><a href="show_result.php" target="_blank" id="show_result" class="list_col">Show  Result </a></li>
				<li><a href="player_data.php" id="player_data" target="_blank" class="list_col">Players Data</a></li>
		...
		<ul id="reg_teams">
		<?php 
			// Showing Current Registered Teams on right side of main page
